...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.weight'
        db.add_column('gallery_gallery', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Gallery.weight'
        db.delete_column('gallery_gallery', 'weight')

    models = {
        'gallery.gallery': {
            'Meta': {'ordering': "('weight', 'date_created', '-id')", 'object_name': 'Gallery'},
        ...
        'gallery.photo': {
            'Meta': {'ordering': "('weight', 'date_created', '-id')", 'object_name': 'Photo'},
